...
MONSTER("grinning idiot", 'g',   1,    6, defaultai,               0.3,   4,   4,    1,    1,     4,   1,  2,    MF_CANUSEWEAPON)
MONSTER("orc",            'o',   1,    8, hostileai,               0.9,   12, 11,    8,    8,     7,   5,  6,    MF_CANUSEWEAPON|MF_CANUSEARMOR|MF_CANHAVEGOLD)
...
MONSTER("goblin",         'G',   2,   13, hostileai,               1.0,   13, 12,   10,   10,     9,   7,  7,    MF_CANUSEWEAPON|MF_CANUSEARMOR|MF_CANHAVEGOLD)
