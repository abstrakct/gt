...
SOURCES = gt.c world.c namegen.c display.c dungeon.c heightmap.c cmd.c cards.c objects.c you.c creature.c worldview.c inventory.c
...
OBJS    = gt.o world.o namegen.o display.o dungeon.o heightmap.o cmd.o cards.o objects.o you.o creature.o worldview.o inventory.o
